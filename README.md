...
- **Architecture:** Scalable systems, design patterns, clean code  
- **Backend (basics):** Node.js, GraphQL, REST  
- **Other:** Git, Docker, CI/CD, Open Source  
...
⭐️ *Always open to connecting with like-minded developers and building things that scale!*  
